-- =====================================================================
-- LUMIKE - SCHEMA COMPLETO
-- Script consolidado para execução no Supabase
...
-- =====================================================================
-- 4. PRODUTOS (depende de categories e colecoes)
-- =====================================================================
...
CREATE TABLE IF NOT EXISTS products (
  ...
  colecao_id        UUID REFERENCES colecoes(id) ON UPDATE CASCADE ON DELETE SET NULL,
...
-- Função para sincronizar estoque separado com products
...
-- =====================================================================
-- 12. TRIGGERS DE ESTOQUE
-- =====================================================================

-- Sincronizar estoque separado com products
...
-- SAÍDA de estoque ao inserir item de pedido
...
-- ENTRADA de estoque ao inserir item de compra
...
-- Top produtos mais vendidos (últimos 90 dias)
...
-- Usuário admin (senha será atualizada via script)
-- NOTA: A senha aqui é apenas um placeholder. Você deve gerar o hash bcrypt
-- usando o script: lumike-api/scripts/fix-admin-password.ts
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM users WHERE lower(email) = lower('admin@lumike.com')) THEN
    ...
    VALUES (
      'Administrador',
      'admin@lumike.com',
      '$2a$12$KM71iqnS8gI8EEG.i.HEDOHE2hlfvzTCauHoeRULNvjaYADlYBvWq', -- Substitua pelo hash bcrypt real
...
-- 2. Gere o hash bcrypt para a senha do admin usando:
--    - Script: lumike-api/scripts/fix-admin-password.ts
--    - Ou online: https://bcrypt-generator.com/
-- 3. Atualize a senha do admin no banco:
--    UPDATE users SET password = 'hash_bcrypt_aqui' WHERE email = 'admin@lumike.com';
-- 
-- Credenciais padrão:
-- Email: admin@lumike.com
-- Senha: 123456 (após gerar o hash)
-- =====================================================================
